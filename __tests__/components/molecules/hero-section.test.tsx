...
describe("HeroSection Component", () => {
  ...
  it("renders with static headline when useTypewriterEffect is false", () => {
    ...
    render(
      <HeroSection headline={customHeadline} useTypewriterEffect={false} />,
    );
  ...
  it("handles centered prop correctly", () => {
    ...
    const { rerender } = render(
      <HeroSection centered={false} useTypewriterEffect={false} />,
    );
  ...
  it("applies custom text color", () => {
    ...
    render(
      <HeroSection textColor={customTextColor} useTypewriterEffect={false} />,
    );
  ...
  it("applies proper ARIA attributes to components", () => {
    ...
    const subheadlineContainer =
      screen.getByTestId("hero-subheadline").parentElement;
    expect(subheadlineContainer).toHaveAttribute(
      "aria-describedby",
      "hero-heading",
    );
