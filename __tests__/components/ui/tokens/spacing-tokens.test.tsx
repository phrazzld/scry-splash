...
describe('SpacingTokens Component', () => {
  it('renders without errors', () => {
    ...
    // Check description
    expect(screen.getByText('Based on an 8pt grid system (0.5rem = 8px)')).toBeInTheDocument();
  });
  ...
  it('renders descriptions for spacing tokens', () => {
    ...
    expect(screen.getByText('160px (120pt) - large vertical spacing')).toBeInTheDocument();
  });
  ...
  it('renders visual spacing bars with correct widths', () => {
    ...
    const spacingBars = screen.getAllByRole('generic').filter(el => 
