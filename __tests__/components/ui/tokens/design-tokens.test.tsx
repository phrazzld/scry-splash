...
describe('DesignTokens Component', () => {
  it('renders without errors', () => {
    ...
    expect(screen.getByText(/These design tokens form the foundation/)).toBeInTheDocument();
  });
  ...
  it('renders color mapping table correctly', () => {
    ...
    expect(screen.getByText('How Scry design tokens map to shadcn/ui semantic tokens:')).toBeInTheDocument();
  ...
  it('renders typography mapping table correctly', () => {
    ...
    expect(screen.getByText('How Scry typography maps to shadcn/ui components:')).toBeInTheDocument();
