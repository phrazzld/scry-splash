...
describe("NoiseBackground Component", () => {
  ...
  it("renders children correctly", () => {
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Background with child",
    });
  ...
  it("renders multiple children correctly and preserves order", () => {
    render(
      <NoiseBackground
        role="presentation"
        aria-label="Multiple children background"
      >
        <div>First child</div>
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Multiple children background",
    });
  ...
  it("applies custom className", () => {
    ...
    render(
      <NoiseBackground
        ...
        role="presentation"
        aria-label="Custom class background"
      />,
    );

    const noiseBg = screen.getByRole("presentation", {
      name: "Custom class background",
    });
  ...
  it("applies default and custom baseColor correctly", () => {
    ...
    const { rerender } = render(
      <NoiseBackground role="presentation" aria-label="Default color bg" />,
    );

    let noiseBg = screen.getByRole("presentation", {
    ...
    rerender(
      <NoiseBackground
        ...
        role="presentation"
        aria-label="Custom hex color bg"
      />,
    );
    ...
    rerender(
      <NoiseBackground
        baseColor={rgbColor}
        role="presentation"
        aria-label="Custom rgb color bg"
      />,
    );
  ...
  it("applies custom noiseOpacity and verifies default opacity", () => {
    ...
    const { rerender } = render(
      <NoiseBackground role="presentation" aria-label="Default opacity bg" />,
    );

    let noiseBg = screen.getByRole("presentation", {
      name: "Default opacity bg",
    });
  ...
  it("includes an inner div for the noise effect with aria-hidden", () => {
    render(
      <NoiseBackground role="presentation" aria-label="Noise effect bg" />,
    );

    const noiseBg = screen.getByRole("presentation", {
      name: "Noise effect bg",
    });
  ...
  it("verifies noise layer has background related properties", () => {
    render(
      <NoiseBackground
        role="presentation"
        aria-label="Background properties test"
      />,
    );

    const noiseBg = screen.getByRole("presentation", {
      name: "Background properties test",
    });
    const noiseLayer = noiseBg.querySelector("div");
...
describe("NoiseBackground Accessibility", () => {
  ...
  describe("Base Color Variants", () => {
    it("has no accessibility violations with default baseColor", async () => {
      const { container } = render(
        <NoiseBackground
          ...
          role="img"
          aria-label="Default background color noise texture"
        />,
      );
    ...
    it("has no accessibility violations with hex baseColor (#333333)", async () => {
      const { container } = render(
        <NoiseBackground
          baseColor="#333333"
          role="img"
          aria-label="Dark hex color noise texture"
        />,
      );
    ...
    it("has no accessibility violations with rgb baseColor", async () => {
      const { container } = render(
        <NoiseBackground
          ...
          role="img"
          aria-label="Blue RGB color noise texture"
        />,
      );
    ...
    it("has no accessibility violations with rgba baseColor", async () => {
      const { container } = render(
        <NoiseBackground
          baseColor="rgba(100, 150, 200, 0.8)"
          role="img"
          aria-label="Translucent blue noise texture"
        />,
      );
    ...
    it("has no accessibility violations with named color baseColor", async () => {
      const { container } = render(
        <NoiseBackground
          baseColor="darkblue"
          role="img"
          aria-label="Dark blue noise texture"
        />,
      );
    ...
    it("has no accessibility violations with default noiseOpacity (0.02)", async () => {
      const { container } = render(
        <NoiseBackground
          noiseOpacity={0.02}
          role="img"
          aria-label="Default opacity noise texture"
        />,
      );
    ...
    it("has no accessibility violations with low noiseOpacity (0.1)", async () => {
      const { container } = render(
        <NoiseBackground
          noiseOpacity={0.1}
          role="img"
          aria-label="Low opacity noise texture"
        />,
      );
    ...
    it("has no accessibility violations with medium noiseOpacity (0.5)", async () => {
      const { container } = render(
        <NoiseBackground
          noiseOpacity={0.5}
          role="img"
          aria-label="Medium opacity noise texture"
        />,
      );
    ...
    it("has no accessibility violations with high noiseOpacity (0.9)", async () => {
      const { container } = render(
        <NoiseBackground
          noiseOpacity={0.9}
          role="img"
          aria-label="High opacity noise texture"
        />,
      );
    ...
    it("has no accessibility violations with zero noiseOpacity (0)", async () => {
      const { container } = render(
        <NoiseBackground
          noiseOpacity={0}
          role="img"
          aria-label="Zero opacity noise texture"
        />,
      );
    ...
    it("has no accessibility violations with custom className", async () => {
      const { container } = render(
        <NoiseBackground
          ...
          role="img"
          aria-label="Custom class noise texture"
        />,
      );
    ...
    it("has no accessibility violations with multiple custom classNames", async () => {
      const { container } = render(
        <NoiseBackground
          ...
          role="img"
          aria-label="Styled noise texture with multiple classes"
        />,
      );
  ...
  describe("Children Content", () => {
    ...
    it("has no accessibility violations with single child", async () => {
      const { container } = render(
        <NoiseBackground
          role="presentation"
          aria-label="Noise texture with single child content"
        >
    ...
    it("has no accessibility violations with multiple children", async () => {
      const { container } = render(
        <NoiseBackground
          role="presentation"
          aria-label="Noise texture with multiple children"
        >
          <div>First child</div>
          <p>Second child</p>
    ...
    it("has no accessibility violations with semantic children", async () => {
      const { container } = render(
        <NoiseBackground
          role="presentation"
          aria-label="Noise texture with semantic content"
        >
          <h2>Heading</h2>
          <p>Paragraph text</p>
    ...
    it("has no accessibility violations with nested children", async () => {
      const { container } = render(
        <NoiseBackground
          role="presentation"
          aria-label="Noise texture with nested content"
        >
          <div>
  ...
  describe("ARIA Attributes", () => {
    it("has no accessibility violations with aria-label when role is provided", async () => {
      const { container } = render(
        <NoiseBackground role="img" aria-label="Decorative background" />,
      );
    ...
    it("has no accessibility violations with aria-hidden", async () => {
      const { container } = render(<NoiseBackground aria-hidden="true" />);
...
describe("NoiseBackground Edge Cases", () => {
  it("renders correctly with no children", () => {
    render(
      <NoiseBackground
        role="presentation"
        aria-label="Empty noise background"
      />,
    );

    const noiseBg = screen.getByRole("presentation", {
      name: "Empty noise background",
    });
    expect(noiseBg).toBeInTheDocument();
    expect(noiseBg).toHaveClass("relative");
  ...
  it("renders correctly with null children", () => {
    render(
      <NoiseBackground
        role="presentation"
        aria-label="Null children noise background"
      >
        {null}
      </NoiseBackground>,
    );
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Null children noise background",
    });
    expect(noiseBg).toBeInTheDocument();
    expect(noiseBg).toHaveClass("relative");
  ...
  it("renders correctly with undefined children", () => {
    render(
      <NoiseBackground
        role="presentation"
        aria-label="Undefined children noise background"
      >
        {undefined}
      </NoiseBackground>,
    );
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Undefined children noise background",
    });
    expect(noiseBg).toBeInTheDocument();
    expect(noiseBg).toHaveClass("relative");
  ...
  it("applies props correctly when rendered with no children", () => {
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Noise background with custom props",
    });
    expect(noiseBg).toHaveClass(customClass);
    expect(noiseBg).toHaveStyle({ backgroundColor: customColor });
  ...
  it("has no accessibility violations when rendered with no children", async () => {
    const { container } = render(
      <NoiseBackground
        role="img"
        aria-label="Empty noise background for a11y testing"
      />,
    );
...
describe("NoiseBackground HTML Attribute Passthrough", () => {
  ...
  it("passes through multiple data-* attributes", () => {
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Noise background with data attributes",
    });
  ...
  it("passes through event handler attributes", () => {
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Noise background with click handler",
    });
    noiseBg.click();
  ...
  it("passes through style attribute correctly", () => {
    ...
    const noiseBg = screen.getByRole("presentation", {
      name: "Noise background with custom styles",
    });
  ...
  it("correctly applies both component props and HTML attributes together", () => {
    ...
    const noiseBg = screen.getByRole("img", {
      name: "Noise background with combined attributes",
    });
