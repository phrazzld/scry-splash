...
beforeEach(() => {
  ...
  jest
    .spyOn(document.documentElement, "dataset", "get")
    .mockImplementation(() => ({
      get theme() {
        return themeDatasetTracker.currentTheme;
      },
      set theme(value) {
        themeDatasetTracker.currentTheme = value;
      },
    }));
});
...
describe("ThemeProvider and useTheme hook", () => {
  ...
  describe("useTheme Hook", () => {
    ...
    it("should be properly guarded against usage outside provider", () => {
      ...
      expect(hookImplementation).toContain(
