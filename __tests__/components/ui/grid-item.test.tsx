...
describe("GridItem Component", () => {
  describe("Basic Rendering", () => {
    ...
    it("applies custom className and merges with default classes", () => {
      ...
      const gridItem = screen.getByRole("region", {
        name: "Custom class grid item",
      });
  ...
  describe("Props and Variants", () => {
    ...
    describe("Span Props", () => {
      ...
      it("processes span prop correctly", () => {
        const { rerender } = render(
          <GridItem span={6} role="region" aria-label="Span 6 grid item">
            Span 6 content
          </GridItem>,
        );
        ...
        rerender(
          <GridItem span={3} role="region" aria-label="Span 6 grid item">
            Span 6 content
          </GridItem>,
        );
        ...
        rerender(
          <GridItem role="region" aria-label="Span 6 grid item">
            Span 6 content
          </GridItem>,
        );
      ...
      it("applies different styling for different span values", () => {
        ...
        const { getByRole } = render(
          <>
            <GridItem span={1} role="region" aria-label="span 1">
              Span 1 content
            </GridItem>
            <GridItem span={4} role="region" aria-label="span 4">
              Span 4 content
            </GridItem>
            <GridItem span={6} role="region" aria-label="span 6">
              Span 6 content
            </GridItem>
            <GridItem span={12} role="region" aria-label="span 12">
              Span 12 content
            </GridItem>
          </>,
        );
    ...
    describe("Responsive Span Props", () => {
      ...
      it("processes individual responsive span props correctly", () => {
        ...
        breakpoints.forEach((breakpoint) => {
          ...
          const gridItem = getByRole("region", {
            name: `${breakpoint} breakpoint item`,
          });
          expect(gridItem).toBeInTheDocument();
      ...
      it("applies different styling for different responsive span combinations", () => {
        ...
        const { getByRole } = render(
          <>
            <GridItem span={12} sm={6} role="region" aria-label="combo 1">
              Combo 1 content
            </GridItem>
            <GridItem span={12} md={6} role="region" aria-label="combo 2">
              Combo 2 content
            </GridItem>
            <GridItem span={12} lg={6} role="region" aria-label="combo 3">
              Combo 3 content
            </GridItem>
            <GridItem span={12} xl={6} role="region" aria-label="combo 4">
              Combo 4 content
            </GridItem>
            <GridItem
              sm={6}
    ...
    describe("Start Props", () => {
      it("processes start prop correctly", () => {
        const { rerender } = render(
          <GridItem start={2} role="region" aria-label="Start position item">
            Start position content
          </GridItem>,
        );

        let gridItem = screen.getByRole("region", {
          name: "Start position item",
        });
        ...
        rerender(
          <GridItem start={5} role="region" aria-label="Start position item">
            Start position content
          </GridItem>,
        );
      ...
      it("applies different styling for different start values", () => {
        ...
        const { getByRole } = render(
          <>
            <GridItem start={1} role="region" aria-label="start 1">
              Start 1 content
            </GridItem>
            <GridItem start={3} role="region" aria-label="start 3">
              Start 3 content
            </GridItem>
            <GridItem start={5} role="region" aria-label="start 5">
              Start 5 content
            </GridItem>
            <GridItem start={9} role="region" aria-label="start 9">
              Start 9 content
            </GridItem>
          </>,
        );
    ...
    describe("Responsive Start Props", () => {
      ...
      it("processes individual responsive start props correctly", () => {
        ...
        breakpoints.forEach((breakpoint) => {
          ...
          render(<GridItem {...props}>Content for {breakpoint}</GridItem>);

          const gridItem = screen.getByRole("region", {
            name: `${breakpoint} responsive item`,
          });
          expect(gridItem).toBeInTheDocument();
          expect(gridItem).not.toHaveAttribute(breakpoint);
        });
    ...
    describe("Combined Props", () => {
      ...
      it("applies different styling for different prop combinations", () => {
        ...
        const { getByRole } = render(
          <>
            <GridItem span={6} start={2} role="region" aria-label="combo 1">
              Combo 1 content
            </GridItem>
            <GridItem
              span={6}
  ...
  describe("Edge Cases", () => {
    ...
    it("renders GridItem correctly with undefined children", () => {
      render(
        <GridItem data-testid="undefined-grid-item">{undefined}</GridItem>,
      );
    ...
    it("has no accessibility violations when rendering empty GridItem", async () => {
      const { container } = render(<GridItem data-testid="empty-grid-item" />);
