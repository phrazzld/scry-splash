...
describe("SplashPage Component", () => {
  it("renders correctly with default props", () => {
    ...
    expect(pageLayout).toHaveAttribute(
  ...
  it("renders with custom headline and subheadline", () => {
    ...
    render(
      <SplashPage headline={customHeadline} subheadline={customSubheadline} />,
    );
  ...
  it("renders with custom CTA text", () => {
    ...
    render(
      <SplashPage buttonText={customButtonText} microcopy={customMicrocopy} />,
    );
