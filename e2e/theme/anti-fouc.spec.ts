...
test.describe('Anti-FOUC Script', () => {
  test('should apply dark theme immediately on load with dark theme in localStorage', async ({ page }) => {
    ...
    expect(
      ...
      (earlyThemeCheck.indicatorExists && earlyThemeCheck.indicatorTheme === 'dark')
    ).toBeTruthy();
  ...
  test('should apply light theme immediately on load with light theme in localStorage', async ({ page }) => {
    ...
    expect(
      ...
      (earlyThemeCheck.indicatorExists && earlyThemeCheck.indicatorTheme === 'light')
    ).toBeTruthy();
