...
test.describe.skip('CI Debug Example', () => {
  ...
  test('should capture comprehensive debugging information', async ({ page }, testInfo) => {
    ...
    debugLog(`Current page has ${metrics?.resourceMetrics?.resourceCount || 0} resources`);
