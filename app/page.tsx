export default function Home() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      ...
      {/* Grid container */}
      <div className="relative z-10 w-full px-6 grid grid-cols-12 mx-auto">
        {/* Main content - spans full width on mobile, 6 columns centered on desktop */}
        <main className="col-span-12 md:col-span-6 md:col-start-4 flex flex-col items-center mt-vertical-lg mb-vertical-lg">
          {/* Logo area */}
          <div className="mb-8">
          ...
          {/* Main headline */}
          <h2 className="mb-4 text-3xl font-bold text-[#FAFAFA] md:text-4xl lg:text-5xl text-center">
            Memorize less. <span className="text-[#b494e9]">Learn more.</span>
          </h2>
          
          {/* Subheadline */}
          <p className="mb-8 text-xl text-[#FAFAFA]/80 md:text-2xl max-w-xl text-center">
