  ...
  useEffect(() => {
    ...
    if (showCssVars && typeof window !== "undefined") {
      ...
      const variables = {
        ...
        "--muted-foreground": computedStyle
      ...
      <div className="space-y-2">
        <div>
          ...
          <div className="text-muted-foreground">
            Selected: <span className="text-foreground">{theme}</span>
          </div>
          <div className="text-muted-foreground">
            System: <span className="text-foreground">{systemTheme}</span>
          </div>
          <div className="text-muted-foreground">
            Active:{" "}
        ...
        <div>
          ...
          <div className="text-muted-foreground">
            HTML classes: <span className="text-foreground">{htmlClass}</span>
          </div>
          <div className="text-muted-foreground">
            data-theme: <span className="text-foreground">{htmlDataTheme}</span>
          </div>
          <div className="text-muted-foreground">
            localStorage:{" "}
            <span className="text-foreground">{localStorage || "null"}</span>
          </div>
        </div>
