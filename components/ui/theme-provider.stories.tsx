    ...
    <div className="p-6 space-y-8 max-w-3xl mx-auto bg-background text-foreground">
      <div className="flex flex-col gap-2">
        ...
        <Typography variant="body">
          This demonstrates the ThemeProvider functionality with real-time theme
          switching.
        </Typography>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              <Typography variant="body">
                Selected Theme: <span className="font-medium">{theme}</span>
              </Typography>
              <Typography variant="body">
                System Theme: <span className="font-medium">{systemTheme}</span>
              </Typography>
              <Typography variant="body">
                Active Theme:{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-4 bg-card text-card-foreground rounded-lg border border-border">
          ...
          <Typography variant="body" className="mt-2">
            This card uses theme-aware variables like <code>bg-card</code> and{" "}
        ...
        <div className="p-4 bg-muted text-muted-foreground rounded-lg">
          ...
          <Typography variant="body" className="mt-2">
            This section uses theme-aware variables like <code>bg-muted</code>{" "}
            and <code>text-muted-foreground</code>.
          </Typography>
        </div>
      </div>
