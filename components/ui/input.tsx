    ...
    return (
      <div className={cn("flex flex-col w-full", containerClassName)}>
        <input
          type={type}
          className={cn(
            "flex h-12 w-full rounded-md border border-input bg-background px-5 py-3 text-base",
            "text-foreground placeholder:text-foreground/40 focus-visible:outline-none",
