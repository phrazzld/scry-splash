    ...
    <div className={cn("w-full p-8", className)} {...props}>
      <div className="mb-8">
        ...
        <BodyText className="mt-2 text-muted-foreground">
          Scry uses IBM Plex Sans as its primary typeface with a clear
          typographic hierarchy based on a modular scale. The typography system
          is designed for readability and accessibility across all screen sizes.
        </BodyText>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="p-6 rounded-lg border border-border">
          ...
          <BodyText className="mb-4">
            A modern sans-serif typeface with excellent readability and
            flexibility for both display and text usage.
          </BodyText>
      ...
      <div className="mb-12">
        ...
        <BodyText className="mb-6">
          Scry provides type-safe React components for consistent typography
