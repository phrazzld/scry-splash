    ...
    <div className={cn("w-full p-8", className)} {...props}>
      <div className="mb-8">
        ...
        <BodyText className="mt-2 text-muted-foreground">
          ...
          creating a consistent rhythm throughout the interface. The spacing
          tokens control margins, padding, gaps, and layout measurements.
        </BodyText>
      </div>
        ...
        <div className="space-y-8">
          {baseSpacingUnits.map((unit, index) => (
            <div key={index} className="flex items-center gap-4">
              <div className="bg-primary h-8" style={{ width: unit.value }} />
              ...
              <code className="text-body-size font-mono bg-muted px-2 py-1 rounded">
                p-{unit.tailwind}, m-{unit.tailwind}
              </code>
            </div>
          ))}
        </div>
      ...
      <div className="mb-12">
        ...
        <BodyText className="mb-6">
          The Container component supports different gap sizes between grid
          items:
        </BodyText>
