            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="flex flex-col gap-2">
                ...
                <BodyText className={cn("opacity-80", textColor)}>
                  Import notes, PDFs, and conversations without formatting overhead
                </BodyText>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <BodyText className={cn("opacity-80", textColor)}>
                  Our system adapts to your learning, optimizing for long-term retention
                </BodyText>
              </div>
            </div>
            
            <BodyText className={cn("opacity-80 italic", textColor)}>
              No more manual flashcards. No more subjective feedback. Just knowledge that sticks.
            </BodyText>
          </div>
        </div>
      </GridItem>
